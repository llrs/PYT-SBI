...
if __name__ == '__main__':
	...
	msa.call_msa_method(args.m, "blast_record.fa", "aligned.aln", find_executable(args.m))
	...
	(minlist, maxlist) = mut.get_extreme_columns(edited,args.low,args.high,20)
